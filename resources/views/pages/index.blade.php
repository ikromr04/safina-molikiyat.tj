...
@section('content')
  <main class="flex flex-col text-khaki">
    <div class="mt-[-137px] pt-[137px]" id="about">
    ...
    <div class="mt-[-137px] pt-[137px] md:-mt-2 md:pt-2" id="renters">
    ...
    <div class="mt-[-137px] pt-[137px] md:-mt-[97px] md:pt-[97px]" id="owners">
      <x-blocks.transform />
    ...
    <div class="mt-[-137px] pt-[137px] md:-mt-[97px] md:pt-[97px]" id="brokers">
      <x-blocks.advantages />
