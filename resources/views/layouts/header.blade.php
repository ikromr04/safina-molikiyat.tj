<header class="sticky z-40 top-0 pt-[60px] pb-10 bg-[linear-gradient(to_top,transparent_0,#1f2937_40px)] md:static group-[.menu-shown]:bg-onyx xl:text-xl">
  <nav class="container grid grid-cols-[56px_1fr_56px] items-center justify-between gap-y-2 md:flex md:flex-wrap md:gap-y-0 md:gap-x-2 xl:gap-x-1">
    <button
      class="flex justify-center items-center rounded bg-transparent cursor-pointer border-none w-9 h-7 p-0 app-nav-toggler md:hidden"
      type="button"
    >
    ...
    <a
      class="hidden ml-auto text-inherit no-underline items-center h-7 rounded px-2 md:flex font-light xl:font-normal xl:h-9 xl:px-3"
    ...
    <div class="lang ml-auto md:ml-0">
      <button
        class="lang__button lg:!font-normal"
        type="button"
      >
        RU
        <svg
    ...
    <hr class="border-none h-[1px] bg-khaki rounded-full w-full col-span-3">
  </nav>
</header>
